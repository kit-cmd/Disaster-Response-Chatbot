...
export const Info = () => {
    ...
    const infos = [
        {
            name : "태풍",
            content : `핵심 행동요령 태풍이 시작된 때에는 이웃과 함께 신속히 안전한 곳으로 대피하고, 외출을 삼가하며 이웃이나 가족에게 연락하여 안전 여부를 확인하고 위험상황을 알려줍니다.
        ...
        }, 
        {
            name : "대설",
            content : `핵심 행동요령
            자제하고, 외출을 할 경우에는 대중교통을 이용하거나 자동차의 월동 장비를 반드시 구비해야 합니다. 보온 유지를 위해 외투, 장갑, 모자 등을 착용합니다.
